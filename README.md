...
Secret fields such as mail source credentials, Juno passwords, and webhook
configuration are write-only and masked in API responses. SSO providers store
only a `client_secret_ref` such as
