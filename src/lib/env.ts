...
const serverEnvSchema = {
  ...
  AUTH_EXTERNAL_PROVIDER_LOGO_URL: z.string().url().optional(),
  AUTH_EXTERNAL_PROVIDER_BUTTON_LABEL: z.string().min(1).optional(),
  ...
  AUTH_EXTERNAL_PROVIDER_SCOPES: z.string().default("openid email profile"),
  AUTH_ADMIN_EMAIL_ALLOWLIST: z.string().optional(),
  AUTH_EXTERNAL_ADMIN_CLAIM: z.string().min(1).optional(),
  AUTH_EXTERNAL_ADMIN_CLAIM_VALUE: z.string().min(1).optional(),
